      ...
      <div className="max-w-7xl mx-auto">
        <FadeIn>
          <div className="text-center mb-20">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-white">Ce que disent nos clients</h2>
          </div>
        </FadeIn>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <FadeIn key={index} delay={index * 0.1}>
              <div className="bg-[#0a0a0a] border border-white/5 rounded-2xl p-8 hover:border-primary/30 transition-all duration-300 h-full flex flex-col">
